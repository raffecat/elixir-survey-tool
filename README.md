# Xplor Developer Coding Challenge
...
Your application should run as a CLI application (e.g. using [escript](https://hexdocs.pm/mix/master/Mix.Tasks.Escript.Build.html))
...
```
git bundle create xplor-coding-test.bundle master
```
